<?php
	...
	if(!isset($_POST['simpan'])) {
		...
		$id_penulis_tmp = $row + 1; // Menambahkan +1 untuk ID kategori Baru
		$id_penulis_tmp = str_pad($id_penulis_tmp, 3, "0", STR_PAD_LEFT); // Menambahkan "0" sampai panjang 3 digit termasuk ID kategori Baru
		$id_penulis_tmp = 'PL' . $id_penulis_tmp; // Menambahkan prefix 'AG' untuk ID kategori Baru
?>
...
<?php
		...
		// Query
		$sql = "INSERT INTO penulis VALUES ('{$id_penulis}', '{$nama_penulis}')";
		$query = mysqli_query($db_conn, $sql);
