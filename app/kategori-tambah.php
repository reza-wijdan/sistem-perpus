<?php
	...
	if(!isset($_POST['simpan'])) {
		...
		$id_kategori_tmp = str_pad($id_kategori_tmp, 3, "0", STR_PAD_LEFT); // Menambahkan "0" sampai panjang 3 digit termasuk ID kategori Baru
		$id_kategori_tmp = 'KT' . $id_kategori_tmp; // Menambahkan prefix 'AG' untuk ID kategori Baru
?>
...
<?php
		...
		// Query
		$sql = "INSERT INTO kategori VALUES ('{$id_kategori}', '{$nama_kategori}')";
		$query = mysqli_query($db_conn, $sql);
